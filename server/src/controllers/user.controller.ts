...
const createUserSchema = z.object({
  ...
  phone: z.string().regex(/^(\+?[0-9]{10,15})?$/, 'Phone number must be between 10 and 15 digits (optional leading +)').optional().default(''),
...
const updateUserSchema = z.object({
  ...
  phone: z.string().regex(/^(\+?[0-9]{10,15})?$/, 'Phone number must be between 10 and 15 digits (optional leading +)').optional(),
